 ...
 */
@PrepareForTest(GoogleIdTokenVerifier.class)
...
public class AuthFilterSignatureVerifyTest {
	...
	public void setUp() throws URISyntaxException, IOException {
		unit = new AuthFilterSignatureVerify();
	...
	public void testVerifyOk() throws Exception {
		when(unit.tokenVerifier.verify(any(GoogleIdToken.class)))
				.thenReturn(true);
	...
	@Test
	public void testFilter() throws GeneralSecurityException, IOException {
